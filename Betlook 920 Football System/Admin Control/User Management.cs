    ...
    public partial class User_Management : Form
    {
        ...
        private void UpdateButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string str = "Update SignUp set UserName='" + UsernameTextBox.Text + "',Fullname ='" + FullNameTextBox.Text + "',Password ='" + PasswordTextBox.Text + "',PhoneNumber ='" + PhoneNumberTextbox.Text + "',UserRole ='" + UserRoleComboBox.SelectedItem.ToString() + "' Where UserId='" + AccountNumTextBox.Text + "'";
        ...
        private void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            if (AccountNumTextBox.Text == "")
                try
                {
                    ...
                    {
                        string str = "DELETE FROM UserTbl WHERE UserID = '" + AccountNumTextBox.Text + "'";
            ...
            else
            {
                try
                {
                    ...
                    if (dr.Read())
                    {
                        ...
                        AccountNumTextBox.Text = dr.GetValue(0).ToString();
        ...
        private void UserDataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (indexRow >= 0)
            {
                ...
                AccountNumTextBox.Text = row.Cells[0].Value.ToString();
        ...
        private void User_Management_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                UserDataGridView.ForeColor = Color.Black;
            }
            catch (SqlException ex)
            {
                MessageBox.Show(ex.Message);
